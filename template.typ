...
// -- forward letter metadata as strings (map hyphen names to underscore params) --
  letter_name: "Benjamin Soltoff",
  letter_title: "Senior Researcher",
  letter_roomnumber: "TBD Gates Hall",
  letter_phonenumber: "+1 (607) 555-1234",
  letter_faxnumber: "+1 (607) 255-9143",
  letter_email: "ben\@example.edu",
  letter_website: "https:\/\/example.edu",
  letter_logo: "latex-letterhead/Bowers.png",

// Do not try to inject content here; just pass through the document
  doc,
  pagenumbering: "1",
